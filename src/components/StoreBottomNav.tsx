...
const TABS = [
  { to: '/store', icon: ShoppingCart, label: 'Orders' },
  { to: '/store/earnings', icon: DollarSign, label: 'Earnings' },
  { to: '/store/profile', icon: User, label: 'Profile' },
]

export function StoreBottomNav({ pendingCount = 0 }: { pendingCount?: number }) {
  return (
